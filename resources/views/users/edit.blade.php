@extends('layouts.app', ['activePage' => 'user-management', 'titlePage' => __('Editar Usuario')])
              ...
              <div class="card-body ">
                <div class="row">
                  <div class="col-md-12 text-right">
                      <a href="{{ route('user.index') }}" class="btn btn-sm btn-success">{{ __('Regresar al Listado') }}</a>
                  </div>
                </div>
                <div class="row">
